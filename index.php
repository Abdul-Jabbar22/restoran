...
$query = "SELECT * FROM foods WHERE meel_id=1";
$app = new App;
$meals_1 = $app->selectAll($query);


$query = "SELECT * FROM foods WHERE meel_id=2";
$app = new App;
$meals_2 = $app->selectAll($query);



$query = "SELECT * FROM foods WHERE meel_id=3";
$app = new App;
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <a type="button" href="<?php echo APPURL; ?>/add-cart.php?id=<?php echo $meal_1->id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <a type="button" href="<?php echo APPURL; ?>/add-cart.php?id=<?php echo $meal_2->id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                            ...
                            <div class="col-lg-6">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="w-100 d-flex flex-column text-start ps-4">
                                        ...
                                        <a type="button" href="<?php echo APPURL; ?>/add-cart.php?id=<?php echo $meal_3->id; ?>" class="btn btn-primary py-2 top-0 end-0 mt-2 me-2">view</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach; ?>
                ...
                <form method="POST" action="booking-table.php">
                    <div class="row g-3">
                        ...
                        <?php if (isset($_SESSION['user_id'])) : ?>
                            <div class="col-12">
                                <button name="submit" type="submit" class="btn btn-primary w-100 py-3" type="submit">Book Now</button>
                            </div>

                        <?php else : ?>
                            <div class="col-12">
                                <p class="btn  alert-danger" type="submit">Please Login first To Book a Table</p>
                            </div>
                        <?php endif; ?>
