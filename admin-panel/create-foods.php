...
if (isset($_POST['submit'])) {
  ...
  $query = "INSERT INTO foods (name,price,description,meel_id,image) VALUES (:name,
     :price,:description,:meel_id,:image)";
    ...
    <div class="card-body">
      ...
      <form method="POST" action="create-foods.php" enctype="multipart/form-data">
        ...
        <div class="form-outline mb-4 mt-4">
          ...
          <select name="meel_id" class="form-select  form-control" aria-label="Default select example">
