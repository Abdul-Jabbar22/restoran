...
if (isset($_POST['submit'])) {
    ...
    $review = $_POST['review']; // Assuming you have a variable named $review
    $username = $_SESSION['username'];

    $query = "INSERT INTO review (review,username) VALUES (:review,:username)";
    ...
    <div class="row g-0">
        ...
        <div class="col-md-6 bg-dark d-flex align-items-center">
            <div class="p-5 wow fadeInUp" data-wow-delay="0.2s">
                ...
                <form method="POST" action="review.php"> <!-- Corrected form action -->
                    <div class="row g-3">
                        <div class="col-12">
