...
define("APPIMAGES", "http://localhost/restoran/admin-panel/foods-images")
?>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <?php if (isset($_SESSION['username'])) : ?>
                            ...
                            <a href="<?php echo APPURL; ?>/bookingPage.php" class="nav-item nav-link">Bookings</a>

                            <a href="<?php echo APPURL;  ?>/cart.php" class="nav-item nav-link"><i class="fa-sharp fa-solid fa-cart-shopping"></i>Cart</a>
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <?php echo $_SESSION['username']; ?>
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="<?php echo APPURL; ?>/booking.php">Bookings</a></li>
                                    <li><a class="dropdown-item" href="<?php echo APPURL; ?>/orders.php">Orders</a></li>
                                    <li>
                        ...
                        <?php else :  ?>
                            ...
                            <a href="<?php echo APPURL; ?>/login.php" class="nav-item nav-link">Login</a>
                            <a href="<?php echo APPURL; ?>/register.php" class="nav-item nav-link">Register</a>
