...
/* This code block is checking if the `HTTP_REFERER` server variable is set. The `HTTP_REFERER`
variable contains the URL of the page that referred the user to the current page. */
